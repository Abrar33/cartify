...
//   //     return console.log("Products are:", response);
//   //   });
//   // }, []);
...
//                   <NavLink href="#" className="-m-2 flex items-center p-2">
//                     <img
...
//   const [selectedSubcategory, setSelectedSubcategory] = useState(""); // Add state for selected subcategory
...
//   const fetchProductsByCategoryAndSubcategory = () => {
...
//                 src={item.image_url}
//                 alt={item.name}
//                 className="w-full h-32 object-fit mb-2"
//               />
//               <h2 className="text-lg font-medium text-gray-800">{item.name}</h2>
//               <p className="text-sm text-gray-600">{item.description}</p>
//               <p className="text-lg font-semibold text-indigo-600">
